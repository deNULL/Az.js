...
;(function (global: any, factory: any) {
  ...
  let HTML_ENTITIES: any = { nbsp: ' ', quot: '"', gt: '>', lt: '<', amp: '&', ndash: '–' };
   ...
   * @memberof Az
   */
  let Tokens: any = function(this: any, text: string, config: any) {
