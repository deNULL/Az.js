(function (factory) {
    ...
    (function (global, factory) {
        typeof exports === 'object' && typeof module !== 'undefined' ? (module.exports = module.exports || {}) && (module.exports.DAWG = factory(module.exports)) :
            typeof types_1.define === 'function' && types_1.define.amd ? (0, types_1.define)('Az.DAWG', ['Az'], factory) :
                (global.Az = global.Az || {}) && (global.Az.DAWG = factory(global.Az));
    }(this, function (Az) {
        'use strict';
        let ROOT = 0, MISSING = -1, PRECISION_MASK = 0xFFFFFFFF, HAS_LEAF_BIT = 1 << 8, EXTENSION_BIT = 1 << 9, OFFSET_MAX = 1 << 21, IS_LEAF_BIT = 1 << 31;
...
(function (factory) {
    ...
    (function (global, factory) {
        typeof exports === 'object' && typeof module !== 'undefined' ? (module.exports = module.exports || {}) && (module.exports.Morph = factory(module.exports)) :
            typeof types_1.define === 'function' && types_1.define.amd ? (0, types_1.define)('Az.Morph', ['Az', 'Az.DAWG'], factory) :
                (global.Az = global.Az || {}) && (global.Az.Morph = factory(global.Az));
    }(this, function (Az) {
        'use strict';
        /** @namespace Az **/
        let words, probabilities, predictionSuffixes = new Array(3), prefixes = ['', 'по', 'наи'], suffixes, grammemes, paradigms, tags, defaults = {
            ignoreCase: false,
            replacements: { 'е': 'ё' },
            stutter: Infinity,
            typos: 0,
            ...
            forceParse: false,
            normalizeScore: true
        }, initials = 'АБВГДЕЁЖЗИЙКЛМНОПРСТУФХЦЧШЩЭЮЯ', particles = ['-то', '-ка', '-таки', '-де', '-тко', '-тка', '-с', '-ста'], knownPrefixes = [
        ...
        ], autoTypos = [4, 9], UNKN, __init = [], initialized = false;
        ...
        let Tag = function (str) {
            ...
            for (let j = 0; j < 2; j++) {
                let statOrFlex = ['stat', 'flex'][j];
                let grams = this[statOrFlex];
        ...
        DictionaryParse.prototype.base = function () {
            ...
            return (this._base = this.word.substring(prefixes[this.paradigm[(this.formCnt << 1) + this.formIdx]].length, this.word.length - suffixes[this.paradigm[this.formIdx]].length));
        };
        ...
        DictionaryParse.prototype.inflect = function (tag, grammemes) {
            if (!grammemes && typeof tag === 'number') {
                ...
                return new DictionaryParse(prefixes[this.paradigm[(this.formCnt << 1) + tag]] +
                    this.base() +
                    suffixes[this.paradigm[tag]], this.paradigmIdx, tag, 0, 0, this.prefix, this.suffix);
            }
            for (let formIdx = 0; formIdx < this.formCnt; formIdx++) {
                if (tags[this.paradigm[this.formCnt + formIdx]].matches(tag, grammemes)) {
                    return new DictionaryParse(prefixes[this.paradigm[(this.formCnt << 1) + formIdx]] +
                        this.base() +
                        suffixes[this.paradigm[formIdx]], this.paradigmIdx, formIdx, 0, 0, this.prefix, this.suffix);
                }
            }
            return false;
        };
            ...
            Morph.Parsers.Dictionary = function (word, config) {
                ...
                for (let i = 0; i < opts.length; i++) {
                    for (let j = 0; j < opts[i][1].length; j++) {
                        let w = new DictionaryParse(opts[i][0], opts[i][1][j][0], opts[i][1][j][1], opts[i][2], opts[i][3]);
            ...
            Morph.Parsers.HyphenParticle = function (word, config) {
                ...
                for (let k = 0; k < particles.length; k++) {
                    if (word.substr(word.length - particles[k].length) == particles[k]) {
                        ...
                        for (let i = 0; i < opts.length; i++) {
                            for (let j = 0; j < opts[i][1].length; j++) {
                                let w = new DictionaryParse(opts[i][0], opts[i][1][j][0], opts[i][1][j][1], opts[i][2], opts[i][3], '', particles[k]);
                                w.score *= 0.9;
                                lets.push(w);
                            }
                        }
        ...
        Morph.init = function (path, callback) {
            ...
            Az.load(path + '/paradigms.array', 'arraybuffer', function (err, data) {
                ...
                let list = new Uint16Array(data), count = list[0], pos = 1;
                paradigms = [];
...
(function (factory) {
    ...
    (function (global, factory) {
        typeof exports === 'object' && typeof module !== 'undefined' ? (module.exports = module.exports || {}) && (module.exports.Syntax = factory(module.exports)) :
            typeof types_1.define === 'function' && types_1.define.amd ? (0, types_1.define)('Az.Syntax', ['Az'], factory) :
...
(function (factory) {
    ...
    (function (global, factory) {
        typeof exports === 'object' && typeof module !== 'undefined' ? (module.exports = module.exports || {}) && (module.exports.Tokens = factory()) :
            typeof types_1.define === 'function' && types_1.define.amd ? (0, types_1.define)('Az.Tokens', ['Az'], factory) :
        ...
        let Tokens = function (text, config) {
            if (this instanceof Tokens) {
                ...
                if (typeof text == 'string') {
                    this.config = config ? types_1.Az.extend(defaults, config) : defaults;
                    this.append(text);
                }
                else {
                    this.config = text ? types_1.Az.extend(defaults, text) : defaults;
                }
                this.index = -1;
            }
            else {
        ...
        Tokens.prototype.append = function (text, config) {
            ...
            config = config ? types_1.Az.extend(this.config, config) : this.config;
...
(function (factory) {
    ...
    (function (global, factory) {
        typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() :
            typeof types_1.define === 'function' && types_1.define.amd ? (0, types_1.define)('Az', factory) :
                global.Az = factory();
    }(this, function () {
        'use strict';
        /** @namespace Az **/
